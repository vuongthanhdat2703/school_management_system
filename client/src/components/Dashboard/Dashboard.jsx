        ...
        <div className="container-fluid">
          <div className="row">
            ...
            <div className="col-sm-3 department">
              ...
              <div className="line"></div>
              <div className="update">
                <a onClick={handleDepartmentClick}>
                  <i>
                    <FontAwesomeIcon icon={faRotateRight} />
                  </i>
                  Update Now
                ...
                <div className="text-1">
                  ...
                  <div className="content">
                    <p>
                      ...
                      Quae laudantium nostrum, ipsam dolorem aut ut impedit,
                      asperiores officia necessitatibus, reiciendis quisquam
                      reprehenderit architecto amet inventore fugit iure maiores
                      aperiam voluptas?
                    </p>
                  </div>
                </div>
